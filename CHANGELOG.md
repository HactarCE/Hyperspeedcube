...
- Enabled debug info in prerelease builds
...
- Timestamp signature verification errors
...
- Recentering using middle-click, <kbd>Ctrl</kbd>+click (Windows/Linux), or <kbd>Cmd</kbd>+click (macOS)
