...
pub enum WhichSide {
    ...
    //
    // TODO: Are you sure this is ok? Even a 2D conformally convex polytope
    // might be split by a manifold without intersecting it. Consider a polytope
    // bounded by two concentric circles intersected by a pair of parallel
    // lines; this shape can be split by a line that doesn't intersect it.
    Split,
}
...
pub enum AtomicPolytopeCutOutput {
    ...
    NonFlush {
        ...
        /// Whether the intersection polytope was newly generated by the cut.
        is_intersection_new: bool,
    },
}
        ...
        match self {
            ...
            AtomicPolytopeCutOutput::NonFlush {
                ...
                write!(
                    ...
                    if *is_intersection_new { " (new)" } else { "" },
                )
            }
        }
    }
