#![allow(clippy::extra_unused_lifetimes)] // generated by macros; unavoidable AFAICT
...
mod bindings {
    ...
    pub const COLOR_PALETTE_TEXTURE:        BindingMetadata = texture(0, 50, D2, Float { filterable: false });
...
pub(in crate::gfx) struct Pipelines {
    ...
    /// Copy a texture onto another, unpremultiplying alpha.
    pub blit_unpremultiplied: blit::Pipeline,
}
impl Pipelines {
    pub(super) fn new(device: &wgpu::Device) -> Self {
        ...
        Self {
            ...
            blit_unpremultiplied: blit::Pipeline::new(
                device,
                shader_module,
                blit::PipelineParams {
